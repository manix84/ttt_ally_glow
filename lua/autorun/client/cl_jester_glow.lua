...
hook.Add("PreDrawHalos", "JesterHalos", function()
  ...
  if ((ply_role == ROLE_TRAITOR or ply_role == ROLE_HYPNOTIST or ply_role == ROLE_ASSASSIN or ply_role == ROLE_ZOMBIE or ply_role == ROLE_VAMPIRE) and LocalPlayer():Alive() and table.Count(jesters) > 0) then
